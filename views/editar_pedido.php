...
<div class = "menu">
    ...
    ?>
    <form class="formulario" method="post" action="pedido.php">
        <input type="hidden" name="edit" value="true">
        <section class = "container">
                <p>Nome</p>
                <input class="form-control" type="text" name="nome_func" value="<?php echo $dados['nome_func'] ?>">
        </section>
        ...
        <button class="btn btn-secondary btn-block m-3" type="submit"> Editar </button>
    </form>
